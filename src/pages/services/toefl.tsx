    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-2">Test of English as a Foreign Language</h1>
          <div className="flex items-center gap-2 text-base">
            ...
            <span className="text-orange-500">TOEFL</span>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-2/3">
              <div className="mb-8">
                ...
                <h2 className="text-3xl font-bold text-[#1f2b6c] mb-6">Test of English as a Foreign Language</h2>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-[#1f2b6c] mb-4">TOEFL Course Overview</h3>
                    <p className="text-gray-600 mb-4">
                      TOEFL (Test of English as a Foreign Language) is a standardized test that measures the English language ability of non-native speakers wishing to enroll in English-speaking universities. Our comprehensive TOEFL preparation course is designed to help you achieve your target score through focused training on all four test sections: Reading, Listening, Speaking, and Writing.
                    </p>
                    <p className="text-gray-600 mb-4">
                      Our experienced instructors provide personalized guidance, practice tests, and detailed feedback to ensure you're fully prepared for test day. Whether you're taking TOEFL for academic purposes or professional certification, our course covers all the strategies and techniques you need to succeed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Our TOEFL curriculum is structured to provide comprehensive coverage of all test components while focusing on your individual needs. The course includes:
                </p>
                <ul className="list-disc pl-6 mb-6 text-gray-600 space-y-2">
                  <li>Diagnostic assessment to identify your strengths and areas for improvement</li>
                  <li>Intensive training in reading, listening, speaking, and writing skills</li>
                ...
                <p className="text-gray-600 mb-6">
                  Classes are conducted by certified TOEFL trainers with extensive experience in helping students achieve their target scores. Small batch sizes ensure personalized attention for each student.
                </p>
              </div>

              {/* TOEFL Test Sections */}
              <div className="mb-8">
                <h3 className="text-xl font-bold text-[#1f2b6c] mb-4">TOEFL Test Sections</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-600 text-sm">
                        The Reading section contains 3-4 passages from academic texts and includes 30-40 questions. You'll have 54-72 minutes to read the passages and answer the questions.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-600 text-sm">
                        The Listening section includes 3-4 lectures and 2-3 conversations. You'll answer 28-39 questions in 41-57 minutes based on what you hear in the audio recordings.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-600 text-sm">
                        The Speaking section has 4 tasks that test your ability to speak English effectively. You'll have 17 minutes to express your opinion and speak based on reading and listening tasks.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-gray-600 text-sm">
                        The Writing section consists of 2 tasks: an integrated task and an independent task. You'll have 50 minutes to write essay responses that demonstrate your ability to write in English.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-blue-50 p-6 rounded-lg flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-[#1f2b6c]">6-10 Weeks</p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-lg flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-[#1f2b6c]">TOEFL Certificate</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8 bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-[#1f2b6c] mb-4">Why Choose Our TOEFL Preparation Course</h3>
              ...
              <div className="mt-8 bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  <ul className="space-y-2">
                    ...
                    <li>
                      <Link to="/services/toefl" className="block p-2 bg-orange-50 text-orange-500 rounded">
                        <span className="flex items-center">
                          <span className="mr-2">→</span>
                          TOEFL
                        </span>
