    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden"> {/* Increased height from 300px to 500px */}
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-2">Test Preparation</h1> {/* Increased text size */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="rounded-lg overflow-hidden">
              ...
              <p className="text-orange-600 font-medium mb-2">Our Solution</p>
                <h2 className="text-xl font-bold text-blue-2000">Test Preparation</h2>
              </div>
