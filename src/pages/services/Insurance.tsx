    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[500px] overflow-hidden"> {/* Increased height from 300px to 500px */}
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white z-10">
          <h1 className="text-5xl md:text-6xl font-bold mb-2">Insurance</h1> {/* Increased text size */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="rounded-lg overflow-hidden">
              ...
              <p className="text-orange-600 font-medium mb-2">Our Solution</p>
                <h2 className="text-xl font-bold text-blue-900 hover:text-orange-500 transition-colors duration-300 inline-block">Insurance</h2>
              </div>
              ...
              <div className="p-6">
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="lg:w-2/3">
                    ...
                    <h3 className="text-xl font-bold text-blue-900 mt-8 mb-4">Our Insurance Services</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="group relative overflow-hidden rounded-lg shadow-md cursor-pointer">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                          <h4 className="text-white font-semibold group-hover:text-orange-300 transition-colors">Health Insurance</h4>
                        </div>
                      </div>
                      ...
                      <div className="group relative overflow-hidden rounded-lg shadow-md cursor-pointer">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                          <h4 className="text-white font-semibold group-hover:text-orange-300 transition-colors">Travel Insurance</h4>
                        </div>
                      </div>
                      ...
                      <div className="group relative overflow-hidden rounded-lg shadow-md cursor-pointer">
                        <div className="aspect-w-16 aspect-h-9 overflow-hidden">
                          <img
                            src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=800&auto=format&fit=crop&q=60"
                            alt="Accident Insurance"
                            className="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-110"
                          />
                        </div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                          <h4 className="text-white font-semibold group-hover:text-orange-300 transition-colors">Accident Insurance</h4>
                        </div>
                      </div>
                      ...
                      <div className="group relative overflow-hidden rounded-lg shadow-md cursor-pointer">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                          <h4 className="text-white font-semibold group-hover:text-orange-300 transition-colors">Liability Insurance</h4>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-8 bg-blue-50 p-6 rounded-lg text-center">
                <h3 className="text-xl font-bold text-blue-900 mb-2">Need Help with Student Insurance?</h3>
